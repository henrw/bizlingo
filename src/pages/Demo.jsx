        ...
        <>
            <div className="flex justify-center h-[100vh] w-full">
                <div className="flex flex-col max-w-[1440px] justify-between h-full w-full">
                    {(stage !== 2 && stage !== 5) && <ProgressBar stage={stage} stageTotal={5} increStage={() => {setStage(stage+1)}} decreStage={() => {setStage(stage-1)}} />}
                    <div className="flex-grow flex flex-col relative items-center justify-center">
                        <div className="flex flex-col w-3/5">
                            <Onboard stage={stage} setContext={setContext} increStage={() => {setStage(stage+1)}} decreStage={() => {setStage(stage-1)}}/>
                            <Words stage={stage} increStage={() => {setStage(stage+1)}} decreStage={() => {setStage(stage-1)}}/>
